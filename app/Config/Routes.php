...
$routes->get('/intidvbt', 'Intidvbt::index');
$routes->get('/identik', 'Identik::index');
$routes->get('/inticam', 'Inticam::index');
...
$routes->get('/fiber', 'Fiber::index');
$routes->get('/seat', 'Seat::index');
$routes->get('/spare', 'Spare::index');
$routes->get('/shared', 'Shared::index');
$routes->get('/voting', 'Voting::index');
$routes->get('/simdes', 'Simdes::index');
$routes->get('/cyber', 'Cyber::index');
$routes->get('/hospital', 'Hospital::index');
$routes->get('/big', 'Big::index');

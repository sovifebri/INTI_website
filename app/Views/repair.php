   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">REPAIR & MAINTENANCE </h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">INTI Repair Center merupakan layanan pemeliharaan perangkat elektronik dengan penyediaan jaminan spare part/suku cadang dan jasa layanan repair. Dengan cakupan spare pool di 60 kota lebih, sehingga kastemer dapat fokus pada main business/aktifitasnya, sementara pengelolaan spare part dan perbaikan module dapat dilakukan oleh PT INTI.</p>
                        </div>

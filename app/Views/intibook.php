   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">INTIBOOK </h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">INTIBOOK adalah perangkat laptop yang berbasis Intel Platform, dengan kualitas material yang bagus untuk memenuhi kebutuhan pelanggan kantor & rumah.</p>
                        </div>

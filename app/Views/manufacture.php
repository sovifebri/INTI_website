            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content-center align-items-center">
                  <div class="col-md-4">
                     ...
                     <div class="btn_main"><a href="<?= base_url('inti_aio') ?>">INTI AIO</a></div>
                  </div>
                  <!-- <div class="col-md-2"></div> -->
                  <div class="col-md-4">
                     <div><img src="images/INTIBOOK-1.png" class="services_img"></div>
                     <div class="btn_main"><a href="<?= base_url('intibook') ?>">INTIBOOK</a></div>
                  </div>
                  <div class="col-md-4">
                     <div><img src="images/INTI-CROMEBOOK-1.png" class="services_img"></div>
                     <div class="btn_main"><a href="<?= base_url('inti_chrome') ?>">INTI CHROMEBOOK</a></div>
                  </div>
                  <div class="col-md-4">

   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">Shared Service Information</h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">Operasi Layanan Bersama adalah operasi back office yang terpusat dan terkonsolidasi melalui digitalisasi proses dengan perjanjian tingkat layanan tinggi (SLA) dan standarisasi proses. Ini memungkinkan konsolidasi operasi bisnis yang digunakan oleh banyak bagian dari organisasi yang sama. Layanan bersama hemat biaya karena memusatkan operasi back-office yang digunakan oleh banyak divisi dari perusahaan yang sama dan menghilangkan redundansi. Ini juga mendorong proses yang efektif dan efisien dan mengurangi beban bisnis non-inti dan kompleksitas birokrasi.</p>
                        </div>

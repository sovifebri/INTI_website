   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">Big Data Analytics</h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">Big Data Analytics adalah proses lengkap untuk menguji set besar data melalui berbagai alat dan proses untuk menemukan pola yang tidak diketahui, korelasi tersembunyi, tren yang bermakna, dan wawasan lainnya untuk membuat keputusan yang didorong data dalam mengejar hasil yang lebih baik. Alat Big Data Analytics dapat memahami volume data yang sangat besar dan mengubahnya menjadi wawasan bisnis yang berharga.</p>
                        </div>

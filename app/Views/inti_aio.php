   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">INTI AIO </h1>
            <!-- <p class="services_text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration</p> -->
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     <div><img src="images/INTI-AIO-1.png" class="services_img"></div>
                    </div>
                     <div class="col-md-4">
                        <p class="services_text">INTI AIO merupakan perangkat All in One PC (AIO PC) yang semua komponennya termasuk monitor terintegrasi dalam satu unit tunggal, kecuali keyboard dan mouse. INTI AIO menawarkan beberapa keunggulan dibandingkan komputer desktop tradisional. Selain menghemat ruang meja, estetika, ringkas, dan mudah diatur dibandingkan dengan komputer desktop, INTI AIO juga dapat mengurangi konsumsi daya dan panas serta ramah lingkungan.</p>
                        </div>

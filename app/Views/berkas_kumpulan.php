...
<html lang="en">
   ...
   <body>
      ...
      <div class="services_section layout_padding">
         ...
         <div class="container">
            <h1 class="services_taital">Software & Firmware </h1>
            <!-- <p class="services_text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration</p> -->
               ...
               <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    <!-- <img src="E:\WEBSITE\kaktus.jpg" class="card-img-top" alt="E:\WEBSITE\kaktus.jpg"> -->
                     <div class="card-body">
                        <h1 class="card-title"><?= is_array($row) && array_key_exists('title', $row) ? $row['title'] : 'Invalid title data'; ?></a></h5>
                        <p class="card-text"><?= is_array($row) && array_key_exists('keterangan', $row) ? $row['keterangan'] : 'Invalid keterangan data'; ?></p>
                        <?php if (is_array($row) && array_key_exists('id_berkas', $row)) : ?>
    <a class="btn btn-primary" href="<?= base_url('berkas/download/' . $row['id_berkas']); ?>">Download</a>
<?php else : ?>
    <a class="btn btn-primary" href="<?= base_url('/berkas/download/DEFAULT_ID_HERE'); ?>">Download</a>
<?php endif; ?>
                    </div>
                </div>
               </div>

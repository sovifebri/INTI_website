   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">SIMDES (Sistem Informasi Manajemen Desa)</h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">Sistem Informasi Manajemen Desa merupakan sebuah perangkat lunak yang mendukung sistem pengelolaan data dalam menerbitkan surat keterangan, surat pengantar, informasi tentang potensi daerah, dan informasi mengenai masyarakat.</p>
                        <p>+ Meningkatkan pelayanan publik di desa yang berbasis teknologi informasi yang mudah diakses, akurat dan mudah digunakan oleh perangkat desa.</p>
                        <p>+ Meningkatkan pelayanan desa dengan menggunakan teknologi pada KTP Elektronik untuk melakukan pendataan pelayanan masyarakat.</p>
                        </div>

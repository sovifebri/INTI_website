   ...
   <body>
      ...
      <!-- header section end -->
       ...
       <div class="services_section layout_padding">
         <div class="container">
            <h1 class="services_taital">Seat Management</h1>
            ...
            <div class="services_section_2">
               <div class="row g-md-8 justify-content">
                  <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <p class="services_text">Seat Management adalah suatu metode dalam mengkoordinir semua workstation dalam sebuah jaringan yang bekerja dengan cara mengawasi proses instalasi, operasi, serta pemeliharaan perangkat keras dan perangkat lunak di setiap workstation.</p>
                        </div>
